...
return (new cljs.core.UUID(clojure.string.join.call(null,cljs.core.concat.call(null,top_32_bits.call(null),"-",cljs.core.repeatedly.call(null,(4),f),"-4",cljs.core.repeatedly.call(null,(3),f),"-",g.call(null),cljs.core.repeatedly.call(null,(3),f),"-",cljs.core.repeatedly.call(null,(12),f)))));
});
/**
...
return (new cljs.core.UUID(clojure.string.join.call(null,cljs.core.concat.call(null,cljs.core.repeatedly.call(null,(8),f),"-",cljs.core.repeatedly.call(null,(4),f),"-4",cljs.core.repeatedly.call(null,(3),f),"-",g.call(null),cljs.core.repeatedly.call(null,(3),f),"-",cljs.core.repeatedly.call(null,(12),f)))));
});
cljs_uuid_utils.core.uuid_regex = (function (){var x = "[0-9a-fA-F]";
return cljs.core.re_pattern.call(null,[cljs.core.str("^"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("$")].join(''));
})();
/**
...
var temp__4126__auto__ = cljs_uuid_utils.core.valid_uuid_QMARK_.call(null,maybe_uuid);
if(cljs.core.truth_(temp__4126__auto__)){
var uuid = temp__4126__auto__;
